...
beautiful.init(require("gears.filesystem").get_themes_dir() .. "/zenburn/theme.lua")
beautiful.wallpaper = awful.util.get_configuration_dir() .. "/themes/wallpapers/greenskull1.jpg"
...
globalkeys = gears.table.join(
    ...
    -- Standard program
    awful.key({ modkey, "Control"   }, "l", function () awful.spawn("xlock -mode matrix") end,
